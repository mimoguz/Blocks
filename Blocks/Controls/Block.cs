...
public abstract class Block : AvaloniaObject
{
    ...
    public static readonly AttachedProperty<BlockButtonStyle> ButtonStyleProperty = AvaloniaProperty.RegisterAttached<Block, Control, BlockButtonStyle>("ButtonStyle");
    ...
    public static BlockButtonStyle GetButtonStyle(Control control) => control.GetValue(ButtonStyleProperty);
    public static void SetButtonStyle(Control control, BlockButtonStyle value) => control.SetValue(ButtonStyleProperty, value);
}